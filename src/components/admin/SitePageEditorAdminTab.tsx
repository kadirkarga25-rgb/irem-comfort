...
const PAGE_META: Record<SitePage, { title: string; description: string }> = {
  ...
  workshop: { title: 'Atölye', description: 'Üretim aşamalarını, metinlerini ve görsellerini ayrı ayrı yönetin. Beş aşamanın her biri Medya Kütüphanesinden ayrı görsel alabilir.' },
